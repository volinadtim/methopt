...
class Chromosome:
    ...
    def cross(self, other: "Chromosome") -> tuple["Chromosome", "Chromosome"]:
        ...
        # print(
        #     "Splitting A: {}|{}|{}".format(
        #         genes_to_str(part_a), genes_to_str(part_b), genes_to_str(part_c)
        #     )
        # )
        # print(
        #     "Splitting B: {}|{}|{}".format(
        #         genes_to_str(other_part_a),
        #         genes_to_str(other_part_b),
        #         genes_to_str(other_part_c),
        #     )
        # )
...
for epoch in range(epochs):
    ...
    for chromosome in population:
        ...
        if random.random() * 100 <= mutation_percent:
            # print("Mutation: " + str(chromosome) + " - " + str(chromosome.value))
            chromosome.mutate_in_place()
            # print("Mutated: " + str(chromosome) + " - " + str(chromosome.value))
...
# chr_a = Chromosome("12345")
# chr_b = Chromosome("54321")
# chr_c = chr_a.cross(chr_b)
# print(chr_c)
# print(chr_a.value)
# print(chr_b.value)
# print(chr_c[0].value)
